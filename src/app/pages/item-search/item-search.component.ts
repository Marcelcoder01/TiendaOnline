...
export class ItemSearchComponent {
 ...
 this.route.queryParams.subscribe(data =>{
  ...
  //que nos interesa solamente la clave 'results', la cual definimos en el componente header ts

  if (resultsString) {  //si se detecta algo de 'results', osea alguna información en las querys, entonces se ejecuta el resto
